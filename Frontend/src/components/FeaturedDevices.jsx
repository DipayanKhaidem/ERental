...
export default function FeaturedDevicesCarousel({ isLoggedIn, openLogin }) {
  
  
  const navigate = useNavigate();

  
  const handleProtectedNavigation = (deviceId) => {
    if (isLoggedIn) {
          ...
          <div key={device.id} className="card bg-base-100 w-full shadow-sm">
            ...
            <div className="card-body items-center text-center">
              ...
              <div className="card-actions">
                ...
                <button 
                  onClick={() => handleProtectedNavigation(device.id)}
